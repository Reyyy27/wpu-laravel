                    ...
                    <div class="flex overflow-x-scroll hide-scroll-bar dragscroll">
                        ...
                        <div class="flex mt-2 flex-nowrap">
                            @forelse ($thumbnail as $item)
                                <img :class="{ 'border-4 border-serv-button': active === {{ $item->id }} }" @onclick="changeThumbnail('{{ url(Storage::url($item->thumbnail)) }}', {{  $item->id }})" src="{{ url(Storage::url($item->thumbnail)) }}" alt="thumbnail service" class="inline-block mr-2 rounded-lg cursor-pointer h-20 w-36 object-cover">
                            @empty
                                {{-- empty --}}
                            @endforelse
                        </div>
                                ...
                                <div class="flex items-center col-span-12 p-2 lg:col-span-6">
                                    <div class="flex items-center space-x-4">
                                        ...
                                        @else
                                            ...
                                            <path d="M24 20.993V24H0v-2.996A14.977 14.977 0 0112.004 15c4.
                                            904 0 9.26 2.354 11.996 5.993zM16.002 8.999a4 4 0 11-8 04 40
                                            018 0z" />
                                            </svg>
                                        @endif
    ...
    <script>
        function gallery() {
            return {
                ...
                active: 1,
                changethumbnail: function(url, postion) {
                    this.featured = url;
                    this.active = postion;
                }
            }
