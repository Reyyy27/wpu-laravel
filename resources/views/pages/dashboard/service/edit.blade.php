    ...
    <main class="h-full overflow-y-auto">
        ...
        <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
            <ol class="inline-flex p-0 list-none">
                ...
                <li class="flex items-center">
                    <a href="{{ route('member.service.index') }}" class="font-medium">Edit Your Service</a>
                </li>
            </ol>
        </nav>
                                ...
                                <div class="px-4 py-5 sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6 -mb-6">
                                            <label for="estimation & revision limit" class="block mb-3 font-medium text-gray-700 text-md">Estimasi Service & Jumlah Revisi</label>
                                        </div>
                                            ...
                                            <div class="grid grid-cols lg:grid-cols-3 md:grid-cols-2 gap-4">
                                                @forelse ($thumbnail_service as $thumbnail_item)
                                                    <div class="mb-2">
                                                        ...
                                                        <input placeholder="Thumbnail" type="file" name="{{ 'thumbnails['.$thumbnail_item->id.']' }}" id="thumbnail" autocomplete="thumbnails" class="block w-full py-3 mt-3 border-gray-300 rounded-md shadow-sm focus:ring-green-500 sm:text-sm"> 
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            @forelse ($tagline as $tagline_item)
                                                <input placeholder="Tagline" type="text" name="{{ ('taglines['.$tagline_item->id.']') }}" id="taglines" autocomplete="taglines" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ $tagline_item->advantage ?? '' }}" required>
                                            @empty
                                                {{-- empty --}}
                                            @endforelse
