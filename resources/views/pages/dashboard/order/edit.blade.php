                            ...
                            <div class="m-auto text-center">
                                ...
                                <div class="relative mt-0 md:mt-6">
                                    ...
                                    <a href="{{ url(Storage::url($order->file ?? '')) }}" 
                                       class="px-4 py-2 mt-2 text-left text-gray-700 rounded-xl bg-serv-hr" onclick="return confirm('Are you sure you want to download this file?')">
                                       Download File
                                    </a>
                                @else
                        ...
                        @endif
                            ...
                            <div class="">
                                ...
                                <div class="px-1 py-4 text-right">
                                    <a href="{{ route('member.order.index') }}" type="button" class="inline-flex justify-center px-4 py-2 mr-4 text-sm font-medium text-gray-700 bg-white border border-gray-600 rounded-lg shadow-sm hover:bg-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300" onclick="return confirm('Are you sure want to back?, Any changes you makke will not be saved')">
                                        Back
                                    </a>
